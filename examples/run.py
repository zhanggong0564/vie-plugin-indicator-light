...
前置：已 `pip install -e plugins/vie-plugin-indicator-light`；
      权重 ./weights/indicator_light/det_yolo_v2.onnx、indicator_light/rec_v2.onnx 就位。
"""
import os
import sys
import json
...
import vie_plugin_indicator_light.plugin  # noqa: E402,F401  触发 @detection_factory.register("indicator_light")
...
def main():
    ...
    detector = detection_factory.get_scenarios("indicator_light")
